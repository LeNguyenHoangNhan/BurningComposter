...
int WriteJsonFile(const char *first_target_field,
                  const char *first_target_value,
                  const char *second_target_field,
                  const char *second_target_value, const char *file_path) {}
#else
int WriteJsonFile(const char *target_field, const char *target_value,
                  const char *file_path) {
    File file_r = SPIFFS.open(file_path, "r");
